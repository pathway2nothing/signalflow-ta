...
class TestLookAheadBias:
    ...
    def test_lookahead_framework_works(self):
        ...
        np.testing.assert_allclose(good_values[:400], good_values_trunc, rtol=1e-10)
    ...
    def test_rolling_operations_no_lookahead(self):
        ...
        np.testing.assert_allclose(full_sma[valid], trunc_sma[valid], rtol=1e-10)
...
class TestReproducibility:
    ...
    WARMUP_PERIODS: ClassVar[list[int]] = [50, 100, 200]
    TOLERANCE = 1e-10
    ...
    def test_reproducibility_framework_works(self):
        ...
        np.testing.assert_allclose(full_sma[valid], late_sma[valid], rtol=1e-10)
...
class TestEdgeCases:
    ...
    def test_extreme_volatility(self):
        ...
        df = generate_random_walk_ohlcv(n_rows=500, volatility=0.5)
