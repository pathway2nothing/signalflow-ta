...
def get_outputs(cls: Type, params: dict) -> list[str]:
    ...
    for suffix in ('mom', 'smooth', 'price', 'vol', 'stat', 'trend', 'overlay', 'volume'):
...
def get_bounds(cls: Type, category: str) -> tuple[float, float] | None:
    ...
    # Positive-only stats
    if name in ['variancestat', 'stdevstat', 'madstat', 'cvstat', 
                'rangestat', 'iqrstat', 'aadstat', 'entropystat', 
                'jarqueberastat', 'realizedvolstat', 'parkinsonvolstat',
                'garmanklassvolstat', 'rogerssatchellvolstat', 'yangzhangvolstat']:
        return (0, float('inf'))
...
def get_all_indicator_configs() -> list[IndicatorConfig]:
    ...
    try:
        from signalflow.ta import (
            # Momentum
            RsiMom, RocMom, MomMom, CmoMom, StochMom, StochRsiMom,
            WillrMom, CciMom, UoMom, AoMom, MacdMom, PpoMom, TsiMom, TrixMom,
            # Overlap - Smoothers
            SmaSmooth, EmaSmooth, WmaSmooth, RmaSmooth, DemaSmooth, TemaSmooth,
            HmaSmooth, TrimaSmooth, SwmaSmooth, SsfSmooth,
            # Overlap - Adaptive
            KamaSmooth, AlmaSmooth, JmaSmooth, VidyaSmooth, T3Smooth,
            ZlmaSmooth, McGinleySmooth, FramaSmooth,
            # Overlap - Price
            Hl2Price, Hlc3Price, Ohlc4Price, WcpPrice,
            MidpointPrice, MidpricePrice, TypicalPrice,
            # Overlap - Trend
            SupertrendOverlay, HiloOverlay, IchimokuOverlay, ChandelierOverlay,
            # Performance
            LogReturn, PctReturn,
            # Stat - Dispersion
            VarianceStat, StdevStat, MadStat, ZscoreStat, CvStat,
            RangeStat, IqrStat, AadStat, RobustZscoreStat,
            # Stat - Distribution
            MedianStat, QuantileStat, PctRankStat, MinMaxStat,
            SkewStat, KurtosisStat, EntropyStat, JarqueBeraStat,
            ModeDistanceStat, AboveMeanRatioStat,
            # Stat - Memory
            HurstStat, AutocorrStat, VarianceRatioStat,
            # Stat - Regression
            CorrelationStat, BetaStat, RSquaredStat,
            LinRegSlopeStat, LinRegInterceptStat, LinRegResidualStat,
            # Stat - Volatility
            RealizedVolStat, ParkinsonVolStat, GarmanKlassVolStat,
            RogersSatchellVolStat, YangZhangVolStat,
            # Trend
            AdxTrend, AroonTrend, VortexTrend, VhfTrend, ChopTrend,
            PsarTrend, SupertrendTrend, ChandelierTrend, HiloTrend,
            CkspTrend, IchimokuTrend, DpoTrend, QstickTrend, TtmTrend,
            # Volatility
            TrueRangeVol, AtrVol, NatrVol, BollingerVol, KeltnerVol,
            DonchianVol, AccBandsVol, MassIndexVol, UlcerIndexVol, RviVol,
            # Volume
    ...
    configs.extend([
        IndicatorConfig(
            cls=RsiMom, name="RsiMom", category="momentum",
            params={"period": 14},
            requires=["close"],
            outputs=["rsi_14"],
            bounded=(0, 100),
        ...
        IndicatorConfig(
            cls=RocMom, name="RocMom", category="momentum",
            params={"period": 10},
            requires=["close"],
            outputs=["roc_10"],
        ...
        IndicatorConfig(
            cls=MomMom, name="MomMom", category="momentum",
            params={"period": 10},
            requires=["close"],
            outputs=["mom_10"],
            bounded=None,
        ...
        IndicatorConfig(
            cls=CmoMom, name="CmoMom", category="momentum",
            params={"period": 14},
            requires=["close"],
            outputs=["cmo_14"],
            bounded=(-100, 100),
        ...
        IndicatorConfig(
            cls=StochMom, name="StochMom", category="momentum",
        ...
        IndicatorConfig(
            cls=StochRsiMom, name="StochRsiMom", category="momentum",
        ...
        IndicatorConfig(
            cls=WillrMom, name="WillrMom", category="momentum",
            params={"period": 14},
            requires=["high", "low", "close"],
            outputs=["willr_14"],
            bounded=(-100, 0),
        ...
        IndicatorConfig(
            cls=CciMom, name="CciMom", category="momentum",
            params={"period": 20},
            requires=["high", "low", "close"],
            outputs=["cci_20"],
        ...
        IndicatorConfig(
            cls=UoMom, name="UoMom", category="momentum",
        ...
        IndicatorConfig(
            cls=AoMom, name="AoMom", category="momentum",
        ...
        IndicatorConfig(
            cls=MacdMom, name="MacdMom", category="momentum",
        ...
        IndicatorConfig(
            cls=PpoMom, name="PpoMom", category="momentum",
            params={"fast": 12, "slow": 26, "signal": 9},
            requires=["close"],
        ...
        IndicatorConfig(
            cls=TsiMom, name="TsiMom", category="momentum",
        ...
        IndicatorConfig(
            cls=TrixMom, name="TrixMom", category="momentum",
            params={"period": 15},
            requires=["close"],
            outputs=["trix_15"],
            bounded=None,
    ...
    configs.extend([
        IndicatorConfig(
            cls=SmaSmooth, name="SmaSmooth", category="overlap",
        ...
        IndicatorConfig(
            cls=EmaSmooth, name="EmaSmooth", category="overlap",
            params={"period": 20, "source_col": "close"},
            requires=["close"],
            outputs=["ema_20"],
            bounded=None,
        ...
        IndicatorConfig(
            cls=WmaSmooth, name="WmaSmooth", category="overlap",
            params={"period": 20, "source_col": "close"},
            requires=["close"],
            outputs=["wma_20"],
            bounded=None,
        ...
        IndicatorConfig(
            cls=RmaSmooth, name="RmaSmooth", category="overlap",
            params={"period": 20, "source_col": "close"},
            requires=["close"],
            outputs=["rma_20"],
            bounded=None,
        ...
        IndicatorConfig(
            cls=DemaSmooth, name="DemaSmooth", category="overlap",
            params={"period": 20, "source_col": "close"},
            requires=["close"],
            outputs=["dema_20"],
            bounded=None,
        ...
        IndicatorConfig(
            cls=TemaSmooth, name="TemaSmooth", category="overlap",
            params={"period": 20, "source_col": "close"},
            requires=["close"],
            outputs=["tema_20"],
            bounded=None,
        ...
        IndicatorConfig(
            cls=HmaSmooth, name="HmaSmooth", category="overlap",
            params={"period": 20, "source_col": "close"},
            requires=["close"],
            outputs=["hma_20"],
            bounded=None,
        ...
        IndicatorConfig(
            cls=TrimaSmooth, name="TrimaSmooth", category="overlap",
            params={"period": 20, "source_col": "close"},
            requires=["close"],
            outputs=["trima_20"],
            bounded=None,
        ...
        IndicatorConfig(
            cls=SwmaSmooth, name="SwmaSmooth", category="overlap",
        ...
        IndicatorConfig(
            cls=SsfSmooth, name="SsfSmooth", category="overlap",
    ...
    configs.extend([
        IndicatorConfig(
            cls=KamaSmooth, name="KamaSmooth", category="overlap",
        ...
        IndicatorConfig(
            cls=AlmaSmooth, name="AlmaSmooth", category="overlap",
            params={"period": 20, "offset": 0.85, "sigma": 6, "source_col": "close"},
            requires=["close"],
            outputs=["alma_20"],
            bounded=None,
            warmup=20,
        ...
        IndicatorConfig(
            cls=JmaSmooth, name="JmaSmooth", category="overlap",
        ...
        IndicatorConfig(
            cls=VidyaSmooth, name="VidyaSmooth", category="overlap",
        ...
        IndicatorConfig(
            cls=T3Smooth, name="T3Smooth", category="overlap",
        ...
        IndicatorConfig(
            cls=ZlmaSmooth, name="ZlmaSmooth", category="overlap",
            params={"period": 20, "source_col": "close"},
            requires=["close"],
            outputs=["zlma_20"],
            bounded=None,
        ...
        IndicatorConfig(
            cls=McGinleySmooth, name="McGinleySmooth", category="overlap",
            params={"period": 14, "source_col": "close"},
            requires=["close"],
            outputs=["mcginley_14"],
            bounded=None,
        ...
        IndicatorConfig(
            cls=FramaSmooth, name="FramaSmooth", category="overlap",
    ...
    configs.extend([
        IndicatorConfig(
            cls=Hl2Price, name="Hl2Price", category="overlap",
            params={},
            requires=["high", "low"],
            outputs=["hl2"],
            bounded=None,
        ...
        IndicatorConfig(
            cls=Hlc3Price, name="Hlc3Price", category="overlap",
            params={},
            requires=["high", "low", "close"],
            outputs=["hlc3"],
            bounded=None,
        ...
        IndicatorConfig(
            cls=Ohlc4Price, name="Ohlc4Price", category="overlap",
            params={},
        ...
        IndicatorConfig(
            cls=WcpPrice, name="WcpPrice", category="overlap",
            params={},
            requires=["high", "low", "close"],
            outputs=["wcp"],
            bounded=None,
        ...
        IndicatorConfig(
            cls=MidpointPrice, name="MidpointPrice", category="overlap",
            params={"period": 14, "source_col": "close"},
            requires=["close"],
            outputs=["midpoint_14"],
            bounded=None,
        ...
        IndicatorConfig(
            cls=MidpricePrice, name="MidpricePrice", category="overlap",
            params={"period": 14},
            requires=["high", "low"],
            outputs=["midprice_14"],
            bounded=None,
        ...
        IndicatorConfig(
            cls=TypicalPrice, name="TypicalPrice", category="overlap",
            params={},
            requires=["high", "low", "close"],
            outputs=["typical"],
            bounded=None,
    ...
    configs.extend([
        IndicatorConfig(
            cls=SupertrendOverlay, name="SupertrendOverlay", category="overlap",
        ...
        IndicatorConfig(
            cls=HiloOverlay, name="HiloOverlay", category="overlap",
            params={"period": 14},
            requires=["high", "low", "close"],
            outputs=["hilo_14"],
            bounded=None,
        ...
        IndicatorConfig(
            cls=IchimokuOverlay, name="IchimokuOverlay", category="overlap",
            params={"tenkan": 9, "kijun": 26, "senkou": 52},
            requires=["high", "low", "close"],
            outputs=["ichimoku_tenkan", "ichimoku_kijun", "ichimoku_senkou_a", "ichimoku_senkou_b", "ichimoku_chikou"],
            bounded=None,
            warmup=55,
        ),
        IndicatorConfig(
            cls=ChandelierOverlay, name="ChandelierOverlay", category="overlap",
    ...
    configs.extend([
        IndicatorConfig(
            cls=LogReturn, name="LogReturn", category="performance",
        ...
        IndicatorConfig(
            cls=PctReturn, name="PctReturn", category="performance",
            params={"period": 1, "source_col": "close"},
            requires=["close"],
    ...
    configs.extend([
        IndicatorConfig(
            cls=VarianceStat, name="VarianceStat", category="stat",
        ...
        IndicatorConfig(
            cls=StdevStat, name="StdevStat", category="stat",
            params={"period": 30, "source_col": "close"},
            requires=["close"],
        ...
        IndicatorConfig(
            cls=MadStat, name="MadStat", category="stat",
            params={"period": 30, "source_col": "close"},
            requires=["close"],
        ...
        IndicatorConfig(
            cls=ZscoreStat, name="ZscoreStat", category="stat",
            params={"period": 30, "source_col": "close"},
            requires=["close"],
        ...
        IndicatorConfig(
            cls=CvStat, name="CvStat", category="stat",
            params={"period": 30, "source_col": "close"},
            requires=["close"],
            outputs=["close_cv_30"],
            bounded=(0, float('inf')),
        ...
        IndicatorConfig(
            cls=RangeStat, name="RangeStat", category="stat",
            params={"period": 30, "source_col": "close"},
            requires=["close"],
        ...
        IndicatorConfig(
            cls=IqrStat, name="IqrStat", category="stat",
            params={"period": 30, "source_col": "close"},
            requires=["close"],
        ...
        IndicatorConfig(
            cls=AadStat, name="AadStat", category="stat",
            params={"period": 30, "source_col": "close"},
            requires=["close"],
        ...
        IndicatorConfig(
            cls=RobustZscoreStat, name="RobustZscoreStat", category="stat",
            params={"period": 30, "source_col": "close"},
            requires=["close"],
    ...
    configs.extend([
        IndicatorConfig(
            cls=MedianStat, name="MedianStat", category="stat",
            params={"period": 30, "source_col": "close"},
            requires=["close"],
        ...
        IndicatorConfig(
            cls=QuantileStat, name="QuantileStat", category="stat",
        ...
        IndicatorConfig(
            cls=PctRankStat, name="PctRankStat", category="stat",
            params={"period": 30, "source_col": "close"},
            requires=["close"],
        ...
        IndicatorConfig(
            cls=MinMaxStat, name="MinMaxStat", category="stat",
            params={"period": 30, "source_col": "close"},
            requires=["close"],
        ...
        IndicatorConfig(
            cls=SkewStat, name="SkewStat", category="stat",
            params={"period": 30, "source_col": "close"},
            requires=["close"],
        ...
        IndicatorConfig(
            cls=KurtosisStat, name="KurtosisStat", category="stat",
            params={"period": 30, "source_col": "close"},
            requires=["close"],
        ...
        IndicatorConfig(
            cls=EntropyStat, name="EntropyStat", category="stat",
        ...
        IndicatorConfig(
            cls=JarqueBeraStat, name="JarqueBeraStat", category="stat",
            params={"period": 30, "source_col": "close"},
            requires=["close"],
            outputs=["close_jb_30"],
            bounded=(0, float('inf')),
        ...
        IndicatorConfig(
            cls=ModeDistanceStat, name="ModeDistanceStat", category="stat",
            params={"period": 30, "source_col": "close"},
            requires=["close"],
        ...
        IndicatorConfig(
            cls=AboveMeanRatioStat, name="AboveMeanRatioStat", category="stat",
            params={"period": 30, "source_col": "close"},
            requires=["close"],
    ...
    configs.extend([
        IndicatorConfig(
            cls=HurstStat, name="HurstStat", category="stat",
        ...
        IndicatorConfig(
            cls=AutocorrStat, name="AutocorrStat", category="stat",
        ...
        IndicatorConfig(
            cls=VarianceRatioStat, name="VarianceRatioStat", category="stat",
    ...
    configs.extend([
        IndicatorConfig(
            cls=CorrelationStat, name="CorrelationStat", category="stat",
        ...
        IndicatorConfig(
            cls=BetaStat, name="BetaStat", category="stat",
        ...
        IndicatorConfig(
            cls=RSquaredStat, name="RSquaredStat", category="stat",
            params={"period": 30, "source_col": "close"},
            requires=["close"],
        ...
        IndicatorConfig(
            cls=LinRegSlopeStat, name="LinRegSlopeStat", category="stat",
            params={"period": 30, "source_col": "close"},
            requires=["close"],
        ...
        IndicatorConfig(
            cls=LinRegInterceptStat, name="LinRegInterceptStat", category="stat",
            params={"period": 30, "source_col": "close"},
            requires=["close"],
        ...
        IndicatorConfig(
            cls=LinRegResidualStat, name="LinRegResidualStat", category="stat",
            params={"period": 30, "source_col": "close"},
            requires=["close"],
    ...
    configs.extend([
        IndicatorConfig(
            cls=RealizedVolStat, name="RealizedVolStat", category="stat",
            params={"period": 30, "source_col": "close"},
            requires=["close"],
        ...
        IndicatorConfig(
            cls=ParkinsonVolStat, name="ParkinsonVolStat", category="stat",
            params={"period": 30},
            requires=["high", "low"],
        ...
        IndicatorConfig(
            cls=GarmanKlassVolStat, name="GarmanKlassVolStat", category="stat",
            params={"period": 30},
            requires=["open", "high", "low", "close"],
        ...
        IndicatorConfig(
            cls=RogersSatchellVolStat, name="RogersSatchellVolStat", category="stat",
            params={"period": 30},
            requires=["open", "high", "low", "close"],
        ...
        IndicatorConfig(
            cls=YangZhangVolStat, name="YangZhangVolStat", category="stat",
            params={"period": 30},
            requires=["open", "high", "low", "close"],
    ...
    configs.extend([
        IndicatorConfig(
            cls=AdxTrend, name="AdxTrend", category="trend",
            params={"period": 14},
            requires=["high", "low", "close"],
        ...
        IndicatorConfig(
            cls=AroonTrend, name="AroonTrend", category="trend",
            params={"period": 25},
            requires=["high", "low"],
        ...
        IndicatorConfig(
            cls=VortexTrend, name="VortexTrend", category="trend",
            params={"period": 14},
            requires=["high", "low", "close"],
        ...
        IndicatorConfig(
            cls=VhfTrend, name="VhfTrend", category="trend",
            params={"period": 28},
            requires=["close"],
            outputs=["vhf_28"],
            bounded=(0, float('inf')),
        ...
        IndicatorConfig(
            cls=ChopTrend, name="ChopTrend", category="trend",
            params={"period": 14},
            requires=["high", "low", "close"],
            outputs=["chop_14"],
            bounded=(0, 100),
        ...
        IndicatorConfig(
            cls=PsarTrend, name="PsarTrend", category="trend",
        ...
        IndicatorConfig(
            cls=SupertrendTrend, name="SupertrendTrend", category="trend",
            params={"period": 10, "multiplier": 3.0},
            requires=["high", "low", "close"],
            outputs=["supertrend_10", "supertrend_direction_10"],
            bounded=None,
        ...
        IndicatorConfig(
            cls=ChandelierTrend, name="ChandelierTrend", category="trend",
            params={"period": 22, "multiplier": 3.0},
            requires=["high", "low", "close"],
            outputs=["chandelier_long_22", "chandelier_short_22"],
            bounded=None,
        ...
        IndicatorConfig(
            cls=HiloTrend, name="HiloTrend", category="trend",
            params={"period": 14},
            requires=["high", "low", "close"],
            outputs=["hilo_14"],
            bounded=None,
        ...
        IndicatorConfig(
            cls=CkspTrend, name="CkspTrend", category="trend",
            params={"p": 10, "x": 1, "q": 9},
            requires=["high", "low", "close"],
        ...
        IndicatorConfig(
            cls=IchimokuTrend, name="IchimokuTrend", category="trend",
            params={"tenkan": 9, "kijun": 26, "senkou": 52},
            requires=["high", "low", "close"],
            outputs=["ichimoku_tenkan", "ichimoku_kijun", "ichimoku_senkou_a", "ichimoku_senkou_b"],
            bounded=None,
            warmup=55,
        ),
        IndicatorConfig(
            cls=DpoTrend, name="DpoTrend", category="trend",
            params={"period": 20},
            requires=["close"],
            outputs=["dpo_20"],
            bounded=None,
        ...
        IndicatorConfig(
            cls=QstickTrend, name="QstickTrend", category="trend",
            params={"period": 14},
            requires=["open", "close"],
            outputs=["qstick_14"],
            bounded=None,
        ...
        IndicatorConfig(
            cls=TtmTrend, name="TtmTrend", category="trend",
            params={"period": 20},
            requires=["high", "low", "close"],
    ...
    configs.extend([
        IndicatorConfig(
            cls=TrueRangeVol, name="TrueRangeVol", category="volatility",
            params={},
            requires=["high", "low", "close"],
            outputs=["true_range"],
            bounded=(0, float('inf')),
        ...
        IndicatorConfig(
            cls=AtrVol, name="AtrVol", category="volatility",
            params={"period": 14},
            requires=["high", "low", "close"],
            outputs=["atr_14"],
            bounded=(0, float('inf')),
        ...
        IndicatorConfig(
            cls=NatrVol, name="NatrVol", category="volatility",
            params={"period": 14},
            requires=["high", "low", "close"],
            outputs=["natr_14"],
            bounded=(0, float('inf')),
        ...
        IndicatorConfig(
            cls=BollingerVol, name="BollingerVol", category="volatility",
            params={"period": 20, "std_dev": 2.0},
            requires=["close"],
            outputs=["bb_upper_20", "bb_mid_20", "bb_lower_20", "bb_width_20", "bb_pct_20"],
            bounded=None,
            warmup=20,
        ),
        IndicatorConfig(
            cls=KeltnerVol, name="KeltnerVol", category="volatility",
        ...
        IndicatorConfig(
            cls=DonchianVol, name="DonchianVol", category="volatility",
            params={"period": 20},
            requires=["high", "low"],
        ...
        IndicatorConfig(
            cls=AccBandsVol, name="AccBandsVol", category="volatility",
            params={"period": 20},
            requires=["high", "low", "close"],
        ...
        IndicatorConfig(
            cls=MassIndexVol, name="MassIndexVol", category="volatility",
        ...
        IndicatorConfig(
            cls=UlcerIndexVol, name="UlcerIndexVol", category="volatility",
            params={"period": 14},
            requires=["close"],
            outputs=["ulcer_14"],
            bounded=(0, float('inf')),
        ...
        IndicatorConfig(
            cls=RviVol, name="RviVol", category="volatility",
            params={"period": 14},
            requires=["high", "low", "close"],
            outputs=["rvi_14"],
            bounded=(0, float('inf')),
    ...
    configs.extend([
        IndicatorConfig(
            cls=ObvVolume, name="ObvVolume", category="volume",
            params={},
            requires=["close", "volume"],
            outputs=["obv"],
            bounded=None,
        ...
        IndicatorConfig(
            cls=AdVolume, name="AdVolume", category="volume",
            params={},
        ...
        IndicatorConfig(
            cls=PvtVolume, name="PvtVolume", category="volume",
            params={},
            requires=["close", "volume"],
            outputs=["pvt"],
            bounded=None,
        ...
        IndicatorConfig(
            cls=NviVolume, name="NviVolume", category="volume",
            params={},
            requires=["close", "volume"],
            outputs=["nvi"],
            bounded=None,
        ...
        IndicatorConfig(
            cls=PviVolume, name="PviVolume", category="volume",
            params={},
            requires=["close", "volume"],
            outputs=["pvi"],
            bounded=None,
        ...
        IndicatorConfig(
            cls=MfiVolume, name="MfiVolume", category="volume",
            params={"period": 14},
            requires=["high", "low", "close", "volume"],
            outputs=["mfi_14"],
            bounded=(0, 100),
        ...
        IndicatorConfig(
            cls=CmfVolume, name="CmfVolume", category="volume",
            params={"period": 20},
            requires=["high", "low", "close", "volume"],
            outputs=["cmf_20"],
            bounded=(-1, 1),
        ...
        IndicatorConfig(
            cls=EfiVolume, name="EfiVolume", category="volume",
            params={"period": 13},
            requires=["close", "volume"],
            outputs=["efi_13"],
            bounded=None,
        ...
        IndicatorConfig(
            cls=EomVolume, name="EomVolume", category="volume",
        ...
        IndicatorConfig(
            cls=KvoVolume, name="KvoVolume", category="volume",
...
def print_available_indicators():
    ...
    for cat, configs in sorted(by_category.items()):
        ...
        for config in sorted(configs, key=lambda x: x.test_id):
            params_info = ", ".join(f"{k}={v}" for k, v in config.params.items() 
                                     if k not in ('source_col', 'pair_col', 'ts_col'))
