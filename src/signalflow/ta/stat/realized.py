...
class RealizedVolStat(Feature):
    ...
    def compute_pair(self, df: pl.DataFrame) -> pl.DataFrame:
        ...
        return df.with_columns(pl.Series(name=f"realized_vol_{self.period}", values=rv))
...
class GarmanKlassVolStat(Feature):
    ...
    def compute_pair(self, df: pl.DataFrame) -> pl.DataFrame:
        ...
        return df.with_columns(pl.Series(name=f"gk_vol_{self.period}", values=gk))
...
class RogersSatchellVolStat(Feature):
    ...
    def compute_pair(self, df: pl.DataFrame) -> pl.DataFrame:
        ...
        return df.with_columns(pl.Series(name=f"rs_vol_{self.period}", values=rs))
...
class YangZhangVolStat(Feature):
    ...
    def compute_pair(self, df: pl.DataFrame) -> pl.DataFrame:
        ...
        return df.with_columns(pl.Series(name=f"yz_vol_{self.period}", values=yz))
